 ...
 *                            -------------------
 *
 *   adapted from phpbb.com's viewtopic.php
 *   begin                : Saturday, Jun 12, 2004
 *
 ***************************************************************************/
...
//
$sql = "SELECT p.*,  pt.post_text, pt.bbcode_uid
...
*/include($phpbb_root_path . 'includes/page_header_light.'.$phpEx);
...
//
$pagination = /*( $highlight_active ) ? generate_pagination("viewtopic.$phpEx?" . POST_TOPIC_URL . "=$topic_id&amp;postdays=$post_days&amp;postorder=$post_order&amp;highlight=" . $HTTP_GET_VARS['highlight'], $total_replies, $board_config['posts_per_page'], $start) :*/ generate_pagination("viewtopiclight.$phpEx?" . POST_TOPIC_URL . "=$topic_id&amp;postdays=$post_days&amp;postorder=$post_order", $total_replies, $board_config['posts_per_page'], $start);
...
include($phpbb_root_path . 'includes/page_tail_light.'.$phpEx);
