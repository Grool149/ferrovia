...
//	if(num>0){document.getElementById('prec').href="javascript:AfficherGrandePhoto('" + (num-1) + "');";}
//	if(num>(NbImages-1)){document.getElementById('suiv').href="javascript:AfficherGrandePhoto('" + (num+1) + "');";}
}
...
<?php
    ...
    echo '<div id="Grandephoto" onclick="FermerGrandePhoto();"><div id="prec"></div><img src="" alt="" /><br />
    rlgopserkgqsldfopqzlfopqlzepfozekqpfokzeopf<div id="suiv"></div>
    </div>';
...
//    <div class="vignette" onclick="AfficherGrandePhoto(\''.$tab_image[$j].'\',\''.$imPrec.'\',\''.$imSuiv.'\');"> 
    echo
    '
