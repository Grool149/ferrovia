...
function AfficherGrandePhoto(nom) {
    var Photo = document.getElementById('Grandephoto').getElementsByTagName('img')[0];
    Photo.src=nom;
...
<?php
    ...
    echo '<div id="Grandephoto">
    <div class="strut"></div><div class="bloc" onclick="FermerGrandePhoto();"><img src="" alt="" /><br />
