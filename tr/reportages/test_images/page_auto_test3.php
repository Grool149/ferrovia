...
function AfficherGrandePhoto(nom) {
    var Photo = document.getElementById('Grandephoto2').getElementsByTagName('img')[0];
    Photo.src=nom;
//    var MargTop = - 10 - Photo.height/2;
//    var MargGau = - 10 - Photo.width/2;
    document.getElementById('Grandephoto2').style.display = 'block';
//    document.getElementById('Grandephoto').style.marginTop  = MargTop;
//    document.getElementById('Grandephoto').style.marginLeft = "-200px";
//    document.getElementById('Grandephoto').style.margin-top = MargTop;
//    document.getElementById('Grandephoto').style.margin-left = MargGau;
}

function FermerGrandePhoto() {
    document.getElementById('Grandephoto2').style.display = 'none';
}
//-->
</script>
...
//    echo '<div id="Grandephoto" onclick="FermerGrandePhoto();">sdfsdfqfsq<p> <span> <img src="" alt="" /><br />
//    rlgopserkgqsldfopqzlfopqlzepfozekqpfokzeopf </span> </p> </div>';
    echo '<div id="Grandephoto2" onclick="FermerGrandePhoto();">
	<div class="strut"></div><div class="bloc"> 
		<img src="" alt="" /><br />
...
//    $nom_repertoire = 'thumbnails';
    ...
    // Création du thumbnail s'il n'existe pas déjà
    $source = imagecreatefromjpeg($tab_image[$j]); // source de ton image
...
//    $image = '<img class="grand" src="'.$tab_image[$j].'" alt="'.substr($tab_image[$j],0,-4).'" />';
